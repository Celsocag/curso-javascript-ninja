...
/*
    ...
    */
    // ?
        ...
        var operation = {
                soma: function sum (x,y){
                        return x+y;
                },
                subtracao: function sub (x,y){
                        return (x-y);
                },
                multiplicacao: function mult (x,y){
                        return (x*y);
                },
                divisao: function div (x,y){
                        return (x/y);
                },
                resto: function rest (x,y){
                        return (x%y);
                } 
        } ;
    ...
    */
    // ?
        var func = function isOperatorValid (x){
                return ( x === '+'||x === '-'||x === '*'||x === '/'||x === '%') 
        };
    /*
    ...
    */
    // ?
        function calculator (x) {
                ...
                return function numberchek (number1, number2,) {
                        ...
                        if (typeof number1 === !Number || typeof number2 === !Number ) {
                                ...
                                switch (x) {
                                        case '+': 
                                                resultado = operation.soma (number1, number2);
                                                break;
                                        case '-':
                                                resultado = operation.subtracao (number1, number2);
                                                break;
                                        case '*': 
                                                resultado =  operation.multiplicacao (number1, number2);
                                                break;
                                        case '/': 
                                                resultado =  operation.divisao (number1, number2);
                                                break;
                                        case '%': 
                                                resultado =  operation.resto (number1, number2);
                                                break;
                                                
                                }
                                showOperationMessage (x, number1, number2, resultado)
                        }
                }
    ...
    */
        function showOperationMessage (operator,number1,number2,resultado) {
                return console.log ('A operação '+number1 + ' ' + operator+ ' ' + number2 + ' ' + '= '+ resultado);
        }
