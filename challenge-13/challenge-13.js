;(function () {    /*
    ...
    */
        var sul = ['Estados','Ai','Da','Regiao'];
        var sudeste = ['Eu','que','nao','vou','pesquisar','naovimaquiestudargeografia'];
    /*
    ...
    */
    console.log( '\nMais estados adicionados:' );
        brasil.unshift('Estado1','Estado2','Estado3');
        console.log(brasil);
    ...
    */
    var nordeste = ['Os','estados','do','Nordeste'];
